...
def index_page() -> str:
    ...
    faq = [
        ...
        ("Почему три инструмента, а не по одному на метод?",
         ...
         "Сервер показывает 14 инструментов независимо от размера каталога: поиск "
         "метода, карточка метода, вызов, карта разделов и работа с кабинетами. "
         "Каталог при этом остаётся полным."),
...
<p>Здесь каталог лежит файлом рядом с сервером, а инструментов всегда 14,
